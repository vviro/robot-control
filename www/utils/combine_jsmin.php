<?php
   ...
   require_once("jsmin2.php"); // get the JSMin library in
   ...
   $sDocRoot = '/var/www/robot-control';
   ...
   */
   if (isset($_GET['version'])) {
      ...
      $sMergedFilename = "$sDocRoot/".ARCHIVE_FOLDER."/$iETag.cache";
